...
?>
        ...
        <form action="05_ex07_object.php" method="post">
              <div style="margin: 20px;  width: 250px;">
                <label for="fname">នាមត្រកូល(firstName):</label>
                <input type="text"  id="fname" placeholder="នាមត្រកូល" name="firstName">
              </div>
              <div style="margin: 20px;  width: 250px;">
                <label for="lname">នាមខ្លួន(lastName):</label>
                <input type="text"  id="lname" placeholder="នាមខ្លួន" name="lastName">
              </div>
